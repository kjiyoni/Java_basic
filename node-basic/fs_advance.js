...
fs.access(path, fs.constants.F_OK | fs.constants.W_OK | fs.constants.W_OK, (error) => {
  if (error) { throw error; }
...
fs_promise.access(dirPath, fs.constants.F_OK | fs.constants.W_OK | fs.constants.W_OK)
  .then(() => {
